...
```{r rf_under, file = "code/randomForest_new.R", echo = FALSE, message = FALSE, warning = FALSE, results = 'asis'}
load("r_objects/rf_under_vip.Rdata")

# vip table
rf_over_vip %>% kbl(booktabs = T, format = "latex", caption = "Random Forest: Variable Importance for Underperforming Districts") %>% kable_classic(full_width = F, html_font = "Cambria") %>% kable_styling(latex_options = 'hold_position')
...
# vip table
rf_vip %>% kbl(booktabs = T, format = "latex", caption = "Random Forest: Variable Importance for All Districts") %>% kable_classic(full_width = F, html_font = "Cambria") %>% kable_styling(latex_options = 'hold_position')
